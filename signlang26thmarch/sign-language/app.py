...
translations = {
    ...
    "my": {"hi": "मेरा", "kn": "ನನ್ನ"},
    "my name is": {"hi": "मेरा नाम है", "kn": "ನನ್ನ ಹೆಸರು"},
    "thank you": {"hi": "धन्यवाद", "kn": "ಧನ್ಯವಾದ"},
    "do you want water": {"hi": "क्या तुम्हें पानी चाहिए?", "kn": "ನಿಮಗೆ ನೀರು ಬೇಕೇ"},
    "call ambulance": {"hi": "एम्बुलेंस बुलाओ", "kn": "ಆಂಬ್ಯುಲೆನ್ಸ್ ಕರೆ"},
    "take care":{"hi":"अपना ध्यान रखना","kn":"ಕಾಳಜಿ ವಹಿಸಿ"},
    "please go ahead":{"hi":"कृपया आगे जाएं","kn":"ದಯವಿಟ್ಟು ಮುಂದೆ ಹೋಗಿ"},
    "i am sorry":{"hi":"मुझे खेद है","kn":"ನಾನು ಕ್ಷಮಿಸಿ"},
    "excuse me":{"hi":"माफ़ करें","kn":"ನನ್ನನ್ನು ಕ್ಷಮಿಸಿ"},
    "you look beautiful":{"hi":"तुम बहुत ही खूबसूरत लग रही हो","kn":"ನೀವು ಸುಂದರವಾಗಿ ಕಾಣುತ್ತೀರಿ"},
    "i congragulate you":{"hi":"मैं तुम्हें बधाई देता हूं","kn":"ನಾನು ನಿನ್ನನ್ನು ಅಭಿನಂದಿಸುತ್ತೇನೆ"},
    "see you":{"hi":"फिर मिलते हैं","kn":"ನಿಮ್ಮನ್ನು ನೋಡುತ್ತೇನೆ"},
    "i am not well":{"hi":"मैं ठिक नहीं हूँ","kn":"ನಾನು ಚೆನ್ನಾಗಿಲ್ಲ"},
    "i love you":{"hi":"मुझे तुमसे प्यार है","kn":"ನಾನು ನಿನ್ನನ್ನು ಪ್ರೀತಿಸುತ್ತೇನೆ"},
    "help me":{"hi":"मेरी सहायता करो","kn":"ನನಗೆ ಸಹಾಯ ಮಾಡಿ"}
}
